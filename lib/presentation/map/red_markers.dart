...
class _MapScreenState extends State<ManyMarkersPage> {
  ...
  void initState() {
    ...
    _bikesStream = FirebaseFirestore.instance.collection('bikes').snapshots(); // Initialize the Firestore stream
  }
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          List<Marker> markers = locations.map((LatLng latLng) {
            return Marker(
              point: latLng,
              builder: (BuildContext context) => Image.asset(ImageConstant.car2),
            );
          }).toList();
